class TitlesSet {
  ...
  /// the normalized title (https://www.mediawiki.org/wiki/API:Query#Example_2:Title_normalization),
  ...
  static TitlesSet fromJson(Map<String, Object?> json) {
    if (json
      ...
      return TitlesSet(
          canonical: canonical, normalized: normalized, display: display);
    }
    throw FormatException('Could not deserialize TitleSet, json=$json');
  }

  @override
  String toString() => 'TitlesSet['
      'canonical=$canonical'
